...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\linewidth]{figs/normal-example}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\linewidth]{figs/basic-ab-ltl-buchii-full}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\linewidth]{figs/exp1-final-path}
  \caption{Environment for Experiment 1}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\linewidth]{figs/choib-example}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\linewidth]{figs/choic-example}
